...
resource "null_resource" "ansible" {
  ...
  provisioner "remote-exec" {
    connection {
      ...
      password = data.vault_generic_secret.ssh.data["admin_username"]
    ...
    inline = [
      ...
      "ansible-pull -i localhost, -U https://github.com/koushikmandalika2411/Roboshop-ansible roboshop.yml -e app_name=${var.component} -e ENV=${var.env}"
    ]
  }
}